...
GLOBAL const Clip SPR_JELLYFLASH_0 = { 64,  32, 16, 16 };
GLOBAL const Clip SPR_JELLYFLASH_1 = { 80,  32, 16, 16 };
...
GLOBAL const Clip* ANM_JELLYFLASH[] = { &SPR_JELLYFLASH_0, &SPR_JELLYFLASH_1                                                                                   };
